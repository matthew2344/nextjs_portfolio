...
export default function MyFooter() {
  return (
    <footer className='font-sans flex flex-col shadow py-4 px-12 text-black dark:text-white bg-stone-100 dark:bg-black border-t border-black/20 dark:border-white/20'>
        <section className="w-full mx-auto max-w-screen-xl p-4 md:flex md:items-center justify-between md:justify-normal">
            <div>               
        ...
        <nav>
            <ul className="w-full mx-auto max-w-screen-xl px-4 grid grid-cols-2 gap-3 md:flex md:flex-nowrap items-center mt-3 text-sm font-medium sm:mt-0">
                <li>
