...
const BottomSheet: React.FC<BottomSheetProps> = ({
    ...
    return(
        <div id="drawer-bottom-example" className="fixed bottom-0 left-0 right-0 z-40 w-full p-4 overflow-y-auto transition-transform bg-white dark:bg-gray-800 transform-none" aria-labelledby="drawer-bottom-label">
